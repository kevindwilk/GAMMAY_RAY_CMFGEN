!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
      SUBROUTINE SOLVE_CMF_FORMAL_V2_GAM(CHI,GAM_ETA,IP,FREQ,NU_DNU,
     *                     INNER_BND_METH,B_NUE,dBDTAU,ND,NP,NC,NA,NU_INDX,GAM_INT)
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
...
!
      CALL REL_VARIABLES(ND,CHI,RAY(IP)%ETA_M,NU_DNU,RAY(IP)%B_M,RAY(IP)%I_M_PREV,CHI_TAU,SOURCE_PRIME)
!
...
! Determine transfer variables.
!
      call rel_variables(nd,chi,RAY(IP)%ETA_P,nu_dnu,ray(ip)%b_p,
