...
!------------------------------------------------------------------------------------------------------------------------------
!
	SUBROUTINE GAMRAY_ENERGY_DEPOSIT_V6(INTENSITY,ETA,CHI_SCAT,CHI_ABS,&
...
!				+CHI_ABS(J+1,I)*TEMP_INT1(J+1,I))
	    TEMP_INT2(I)=TEMP_INT2(I)+0.5D0*(T1-T2)*(CHI_TOT(J,I)*TEMP_INT1(J,I)&
				+CHI_TOT(J+1,I)*TEMP_INT1(J+1,I))
