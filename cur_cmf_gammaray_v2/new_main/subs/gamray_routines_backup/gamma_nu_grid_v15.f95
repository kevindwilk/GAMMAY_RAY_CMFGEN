...
!
!	  DNU_INF2=DLOG10(NU_RED(IGAM)/NU_RED_INF2(IGAM))/FLOAT(GRAY_LINE_MIN-1)
...
!	  WRITE(LUER,'(A5,1X,I3,4X,ES16.6)')'IGAM:',IGAM,BETA_LINE_MIN
	  ...
	  END IF
!	  WRITE(LUER,'(A5,1X,I3,4X,ES16.6)')'IGAM:',IGAM,BETA_TAIL_MIN
!
