...
!
	SUBROUTINE DO_GAM_ABS_APPROX_V2(LOCAL_ABS_ENERGY,TOTAL_DECAY_ENERGY,
	1		KINETIC_DECAY_ENERGY,ND,GAM_ABS_FAC)
	USE MOD_CMFGEN
	IMPLICIT NONE
!
...
!
	CHI(1:ND)=GAM_ABS_FAC*TA(1:ND)*DENSITY(1:ND)*CLUMP_FAC(1:ND)*1.0D+10
!
